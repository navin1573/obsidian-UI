  ...
  return (
    <nav  className="flex items-center justify-between px-6 py-4 text-white font-bold border-b border-white/10 bg-transparent relative">
      ...
      <div className="hidden md:flex items-center gap-6">
        ...
        <a className=" text-gray-300 text-sm hover:text-white hover:bg-white/10 hover:rounded-md transition-colors px-4 py-2  "  href="https://obsidian.md/download">Download</a>
        <a className=" text-gray-300 text-sm hover:text-white hover:bg-white/10 hover:rounded-md transition-colors px-4 py-2  " href="https://obsidian.md/Pricing">Pricing</a>
        <a className=" text-gray-300 text-sm hover:text-white hover:bg-white/10 hover:rounded-md transition-colors px-4 py-2  " href="https://obsidian.md/Sync">Sync</a>
        <a className=" text-gray-300 text-sm hover:text-white hover:bg-white/10 hover:rounded-md transition-colors px-4 py-2  " href="https://obsidian.md/Publish">Publish</a>
        <a className=" text-gray-300 text-sm hover:text-white hover:bg-white/10 hover:rounded-md transition-colors px-4 py-2  " href="https://obsidian.md/Enterprise">Enterprise</a>
        </div>
      ...
      {open && (
        <div className="absolute top-16 right-6 bg-[rgb(17,17,17,0.99)] p-4 rounded-xl shadow-lg z-50 flex flex-col gap-3 md:hidden">
          <a className=" text-gray-300 text-sm hover:text-white hover:bg-white/10 hover:rounded-md transition-colors px-4 py-2  " href="#">Download</a>
          <a className=" text-gray-300 text-sm hover:text-white hover:bg-white/10 hover:rounded-md transition-colors px-4 py-2  " href="#">Pricing</a>
          <a className=" text-gray-300 text-sm hover:text-white hover:bg-white/10 hover:rounded-md transition-colors px-4 py-2  " href="#">Sync</a>
          <a className=" text-gray-300 text-sm hover:text-white hover:bg-white/10 hover:rounded-md transition-colors px-4 py-2  " href="#">Publish</a>
          <a className=" text-gray-300 text-sm hover:text-white hover:bg-white/10 hover:rounded-md transition-colors px-4 py-2  " href="#">Enterprise</a>
          <a className=" text-gray-300 text-sm hover:text-white hover:bg-white/10 hover:rounded-md transition-colors px-4 py-2  " href="#">Community</a>
          <a className=" text-gray-300 text-sm hover:text-white hover:bg-white/10 hover:rounded-md transition-colors px-4 py-2  " href="#">Account</a>
        </div>
      )}
    </nav>
  );
