...
<img src="obsidianlogo.svg" alt="Obsidian Logo" className="w-24 h-24 md:w-32 md:h-32" />
      </div>

      <h2 className="text-2xl font-bold mt-6">Obsidian</h2>
      <p className="text-white font-semibold mt-2">Free without. limits.</p>
      <a href="#" className="text-purple-400 mt-1 font-semibold hover:underline">Download now</a>
    </div>
